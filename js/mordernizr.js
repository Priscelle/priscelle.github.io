...
(window.Modernizr = (function (a, b, c) {
        ...
        for (var d = 0, e, f, h, i = a.length; d < i; d++)
          l.setAttribute("type", (f = a[d])),
            ...
            e &&
              ...
              /^range$/.test(f) && l.style.WebkitAppearance !== c
                ? (g.appendChild(l),
                  (h = b.defaultView),
                  (e =
                    h.getComputedStyle &&
                    h.getComputedStyle(l, null).WebkitAppearance !==
                      "textfield" &&
                    l.offsetHeight !== 0),
                  g.removeChild(l))
                : /^(search|tel)$/.test(f) ||
                  (/^(url|email)$/.test(f)
                    ? (e = l.checkValidity && l.checkValidity() === !1)
                    : /^color$/.test(f)
                    ? (g.appendChild(l),
                      g.offsetWidth,
                      (e = l.value != m),
  ...
  var F = (function (a, c) {
    ...
    [
      ...
      ['#generatedcontent:after{content:"', m, '";visibility:hidden}'].join(""),
    ],
  ...
  (q.flexbox = function () {
    ...
    function a(a, b, c, d) {
      (b += ":"),
        (a.style.cssText =
          (b + o.join(c + ";" + b)).slice(0, -b.length) + (d || ""));
    }
    ...
    (q.canvastext = function () {
      return (
        !!e.canvas &&
        !!B(b.createElement("canvas").getContext("2d").fillText, "function")
      );
    }),
    ...
    (q.video = function () {
      ...
      try {
        if ((c = !!a.canPlayType)) {
          ...
          (c.h264 =
            a.canPlayType(d + '"') || a.canPlayType(d + ', mp4a.40.2"')),
  ...
  for (var H in q)
    y(q, H) &&
      ((w = H.toLowerCase()), (e[w] = q[H]()), t.push((e[w] ? "" : "no-") + w));
  e.input || G(),
    z(""),
    (j = l = null),
    a.attachEvent &&
    ...
    (e.testStyles = u),
    (g.className =
      g.className.replace(/\bno-js\b/, "") + (f ? " js " + t.join(" ") : ""));
  return e;
})(this, this.document)),
  (function (a, b, c) {
    function k(a) {
